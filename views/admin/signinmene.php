...
<html lang="en">
	...
	<body>
		...
		<div class="col-xs-2 Ad_Lef" id="showandhide">
			...
			<div class="Ad_Lef_btn_checked" onclick="SignIn()">
				<span class="col-xs-2 Ad_Lef_btnPic"><a class="glyphicon glyphicon-th-list Ad_Lef_btnA Ad_Lef_btn_colorchange"></a></span>
				<div class="col-xs-10 Ad_Lef_btnWord"><p class="Ad_Lef_btnP Ad_Lef_btn_colorchange">签到情况</p></div>
			</div>
